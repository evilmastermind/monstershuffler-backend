...
import { createSpellHandler, getSpellHandler, getSpellListHandler, updateSpellHandler, deleteSpellHandler } from './spell.controller';
...
async function spellRoutes(server: FastifyInstance) {
  server.post(
    '/filter',
    {
      ...
      schema: {
        summary: 'Returns a list of spells from the db, filtered by the values specified in the body.',
        description: 'Returns a list of spells from the db, filtered by the values specified in the body. If authenticated, also returns the spells created by the user.',
  ...
  server.get(
    '/:spellId',
    {
      preHandler: [server.authenticateOptional],
      schema: {
        summary: 'Returns the details of the spell corresponding to the given id.',
        description: 'Returns the details of the spell corresponding to the given id.',
        headers: jwtHeaderOptional,
        tags: ['spells'],
  ...
  server.put(
    '/:spellId',
    {
      ...
      schema: {
        ...
        description: '[MS ONLY] Updates the spell corresponding to the given id.',
  ...
  server.delete(
    '/:spellId',
    {
      ...
      schema: {
        ...
        description: '[MS ONLY] Deletes the spell corresponding to the given id.',
        tags: ['spells'],
        headers: jwtHeaderRequired,
        response: {
          200: BatchPayload
