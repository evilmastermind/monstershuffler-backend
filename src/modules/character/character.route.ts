...
import { createCharacterHandler, getCharacterHandler, getCharacterListHandler, updateCharacterHandler, deleteCharacterHandler  } from './character.controller';
...
async function characterRoutes(server: FastifyInstance) {
  server.get(
    '/',
    {
      ...
      schema: {
        ...
        description: 'Returns a list of all available characters in the db. If authenticated, also returns the list of characters created by the user.',
  ...
  server.get(
    '/:characterId',
    {
      preHandler: [server.authenticateOptional],
      schema: {
        summary: 'Returns the details of the character corresponding to the given id.',
        description: 'Returns the details of the character corresponding to the given id.',
        headers: jwtHeaderOptional,
        tags: ['characters'],
  ...
  server.delete(
    '/:characterId',
    {
      preHandler: [server.authenticate],
      schema: {
        summary: '[MS ONLY] Deletes the character corresponding to the given id.',
        description: '[MS ONLY] Deletes the character corresponding to the given id.',
        tags: ['characters'],
        headers: jwtHeaderRequired,
        response: {
          200: BatchPayload
