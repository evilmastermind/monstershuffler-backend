...
import { createTemplateHandler, getTemplateHandler, getTemplateListHandler, updateTemplateHandler, deleteTemplateHandler  } from './template.controller';
...
async function templateRoutes(server: FastifyInstance) {
  server.get(
    '/',
    {
      ...
      schema: {
        ...
        description: 'Returns a list of all available templates in the db. If authenticated, also returns the list of templates created by the user.',
  ...
  server.get(
    '/:templateId',
    {
      preHandler: [server.authenticateOptional],
      schema: {
        summary: 'Returns the details of the template corresponding to the given id.',
        description: 'Returns the details of the template corresponding to the given id.',
        headers: jwtHeaderOptional,
        tags: ['templates'],
  ...
  server.delete(
    '/:templateId',
    {
      preHandler: [server.authenticate],
      schema: {
        summary: '[MS ONLY] Deletes the template corresponding to the given id.',
        description: '[MS ONLY] Deletes the template corresponding to the given id.',
        tags: ['templates'],
        headers: jwtHeaderRequired,
        response: {
          200: BatchPayload
