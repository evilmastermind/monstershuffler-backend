...
import { createFolderHandler, getFolderContentHandler, updateFolderHandler, deleteFolderHandler } from './folder.controller';
...
async function folderRoutes(server: FastifyInstance) {
  ...
  server.delete(
    ...
    {
      schema: {
        summary: 'Deletes a folder, moving its content inside the trash folder.',
        description: 'Deletes a folder, moving its content inside the trash folder.',
        tags: ['folders'],
        // params: $ref('getFolderParamsSchema'),
        headers: jwtHeaderRequired,
        response: {
